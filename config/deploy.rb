server '52.70.196.201', roles: %w{app db web}, primary: true
 
set :repo_url,        'git@github.com:jayesh678/first_project.git'
...
set :deploy_to,       "/home/ubuntu/project/#{fetch(:application)}"
